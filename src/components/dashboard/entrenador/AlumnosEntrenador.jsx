// components/dashboard/entrenador/AlumnosEntrenador.jsx
import React from 'react'
import { Users } from 'lucide-react'

const AlumnosEntrenador = ({ user }) => {
  return (
    <div className="h-full flex flex-col">
      <div className="bg-[#1a1a1a]/80 backdrop-blur-sm border-b border-[#2d2d2d] px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Gestiona los alumnos que entrenas</p>
          </div>
        </div>
      </div>
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Próximamente podrás gestionar tus alumnos desde esta sección.</p>
        </div>
      </div>
    </div>
  )
...
export default AlumnosEntrenador